...
//   constructor(private coursesService: CoursesService ,@Inject(DOCUMENT) private document: Document, @Inject(WINDOW) private window: Window,private formBuilder: FormBuilder, private degreesService:DegreesService) { 
...
//     this.degreesSearch();
//     // console.log(this.degreesSearch());    
...
//   degreesSearch(){
//     let searchObj:any = {}
//     searchObj.name = "Future";
//     this.degreesService.degreesSearch(searchObj).subscribe((result:any)=>{
//       this.data = result.data;
//       console.log(result.data);
//       this.programData = this.data.program;
//       this.imageHost = this.degreesService.imageHost;
//       this.degreesService.storageSave(this.data);
//     })
//   }
//   pageNavigate(courseName:any){
//       this.degreesService.navigatePage(courseName);
//   }
...
// onsubmit(){
//   this.profile.sourceOfPage = "All programs";
