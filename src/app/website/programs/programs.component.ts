...
export class ProgramsComponent implements OnInit {
  ...
  constructor(private coursesService: CoursesService ,@Inject(DOCUMENT) private document: Document, @Inject(WINDOW) private window: Window,private formBuilder: FormBuilder, private programsService:ProgramsService) { 
  ...
  programSearch(){
    let searchObj:any = {}
    searchObj.name = "Programs";
    this.programsService.programsSearch(searchObj).subscribe((result:any)=>{
