...
@Component({
  selector: 'app-onlyatdigitallync',
  templateUrl: './onlyatdigitallync.component.html',
  styleUrls: ['./onlyatdigitallync.component.scss']
})
export class OnlyatdigitallyncComponent implements OnInit {
  courseName:any;
  currentURL = '';
  ...
  constructor(private coursesService: CoursesService ,private headerService:HeaderService,@Inject(DOCUMENT) private document: Document, @Inject(WINDOW) private window: Window,private formBuilder: FormBuilder, private programsService:ProgramsService) { 
...
onsubmit(){
  this.profile.sourceOfPage = "Only at digital lync ProgramS";
