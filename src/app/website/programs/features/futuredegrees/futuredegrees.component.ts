...
@Component({
  selector: 'app-futuredegrees',
  templateUrl: './futuredegrees.component.html',
  styleUrls: ['./futuredegrees.component.scss']
})
export class FuturedegreesComponent implements OnInit {
  courseName:any;
  currentURL = '';
...
onsubmit(){
  this.profile.sourceOfPage = "Future Degrees Programs";
